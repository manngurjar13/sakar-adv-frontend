      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            ...
            <span className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
              Sakar Advertising & Marketing Solution
            </span>
          </Link>
        </div>
        ...
        <div className="text-center mb-6 sm:mb-8">
          <nav className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8">
            <Link
              to="/"
              className="text-gray-700 hover:text-blue-600 font-medium transition duration-200 text-xs sm:text-sm md:text-base"
            >
              Home
            </Link>
            <Link
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-8 sm:mb-12">
          <a
            href="#"
            className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300 transform hover:scale-110"
          >
            <span className="font-bold text-gray-700 hover:text-white text-sm sm:text-base">
              f
            </span>
          </a>
          ...
          <a
            ...
            className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300 transform hover:scale-110"
          >
            <span className="text-gray-700 hover:text-white text-sm sm:text-base">
              📷
            </span>
          </a>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 sm:pt-8 border-t border-gray-200 gap-4 sm:gap-0">
          ...
          <div className="text-gray-600 text-xs sm:text-sm text-center sm:text-left">
            © 2025  Sakar Advertising & Marketing Solution. All rights reserved.
          </div>
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6">
            <a
              href="#"
              className="text-gray-600 hover:text-blue-600 text-xs sm:text-sm font-medium transition duration-200"
            >
              Privacy Policy
            </a>
            <a
