        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0 py-3 sm:py-2.5">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link 
                to="https://share.google/RRRUYeAIXhL6QMSmi" 
                target="_blank"
                rel="noopener noreferrer"
                className="group relative h-9 w-9 sm:h-10 sm:w-10 flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-blue-400 hover:border-blue-300 hover:scale-110 transition-all duration-300"
                aria-label="Google"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
