        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
              Large Format
              <span className="block text-orange-300">Hoarding Displays</span>
            </h1>
            <p className="text-blue-100 text-xl mb-10 leading-relaxed max-w-3xl mx-auto">
              Command attention with premium outdoor hoarding solutions at
              high-traffic locations for maximum brand impact.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Strategic billboard placements that ensure your brand is seen by
              lakhs of commuters every single day.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Capture the attention of a wide audience with large-scale
                displays in prime city junctions.
              </p>
            </div>
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Strategic placement at highways, main roads, and commercial hubs
                for 24/7 visibility.
              </p>
            </div>
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Establish your brand as a market leader with dominant outdoor
