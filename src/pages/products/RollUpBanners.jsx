        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
              Roll-Up
              <span className="block text-orange-300">Banners</span>
            </h1>
            <p className="text-blue-100 text-xl mb-10 leading-relaxed max-w-3xl mx-auto">
              Portable and professional roll-up banners perfect for events,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Portable, easy-to-use banners that make a powerful impact at any
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Lightweight and compact design with carrying case for easy
                transport and setup.
              </p>
            </div>
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Quick and simple assembly with retractable mechanism for
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed">
                Crisp, vibrant printing with fade-resistant inks for
