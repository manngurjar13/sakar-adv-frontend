        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-blue-100 text-xl mb-10 leading-relaxed max-w-3xl mx-auto">
              Colorful and vibrant banners designed for festivals and special events to create memorable brand experiences.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center">
              Vibrant Festival Banner Solutions
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    Custom festival-themed artwork
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-purple-600 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Festival Applications</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
...
export default FestivalBanners
